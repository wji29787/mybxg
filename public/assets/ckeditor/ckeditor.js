...
(function () {
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, f = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            l = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, m = function (a, e) {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, l = {"#": 1},
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var p = this, f = [], n = this.editor && this.editor.config.protectedSource, e, g = !1,
        ...
        var O = {styles: 1, attributes: 1, classes: 1},
            ...
            I = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, F = /^cke:(object|embed|param)$/,
                    ...
                    if (a(n)) w.push(n); else {
                        ...
                        if ("br" == f) H.push(n); else {
                            for (; !(g = (e = t.name) ? CKEDITOR.dtd[e] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || t.isUnknown || g[f]);) if (t.isOptionalClose) D.onTagClose(e); else if (f in b && e in b) e = t.children, (e = e[e.length - 1]) && "li" == e.name || A(e = new CKEDITOR.htmlParser.element("li"), t), !n.returnPoint && (n.returnPoint = t), t = e; else if (f in CKEDITOR.dtd.$listItem &&
                                !x(f, e)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (e in d && !x(f, e)) !n.returnPoint && (n.returnPoint = t), t = t.parent; else if (e in CKEDITOR.dtd.$inline && w.unshift(t), t.parent) A(t, t.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            m(f);
    ...
    (function () {
        ...
        var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", t = CKEDITOR.dtd,
            ...
            t.$block), p = {elements: {input: l, textarea: l}},
